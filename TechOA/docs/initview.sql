...
select DISTINCT
a.name,a.code,b.name as depart,a.mainjob,a.secjob,a.level,a.email,a.blog,a.selfweb,a.stcphone,a.mobphone,a.address,a.post,c.name as major,d.name as degree,e.name as pro 
