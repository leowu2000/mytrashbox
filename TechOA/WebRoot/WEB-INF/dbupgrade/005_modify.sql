...
select a.*,b.NAME as PJNAME,c.NAME as PJNAME_D,d.NAME as STAGENAME,f.NAME as TYPENAME
	from PLAN a, PROJECT b, PROJECT_D c, DICT d, PLAN_TYPE e, PLAN_TYPE f
	where b.CODE=a.PJCODE and c.CODE=a.PJCODE_D and d.CODE=a.STAGECODE and d.TYPE='5' and e.CODE=a.TYPE and f.CODE=a.TYPE2;
...
INSERT INTO USER_MENU VALUES('000007','005','2');
INSERT INTO USER_MENU VALUES('000007','051','2');
INSERT INTO USER_MENU VALUES('000007','009','2');
INSERT INTO USER_MENU VALUES('000007','091','2');
