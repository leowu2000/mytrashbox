...
<html>
  <head>
	...
	Ext.onReady(function(){
		var tb = new Ext.Toolbar({renderTo:'toolbar'});
  		...
  		function onExportClick(){
    		...
    		window.location.href = "/excel.do?action=export&model=PLAN&f_level=" + level + "&f_type=" + type + "&datepick=" + datepick + "&f_empname=" + encodeURI(empname) + "&isplanner=true";
  		}
	});
	...
	function commit(){
	  ...
	  document.getElementById('list_remind').src = "/plan.do?action=remind_list&f_level=" + level + "&f_type=" + type + "&datepick=" + datepick + "&f_empname=" + encodeURI(empname) + "&sel_empcode=" + sel_empcode + "&isplanner=true";
	}
	</script>
  </head>
