...
<%
	...
	List listBudgetCredited = pageList.getList();
...
Ext.onReady(function(){
    ...
    function onUpdateClick(btn){
		...
		Ext.Ajax.request({
			...
			success: function(transport) {
				...
				Ext.get('_try').set({'value':data.item.__try});
				Ext.get('funds').set({'value':data.item.funds});
				Ext.get('funds1').set({'value':data.item.funds1});
				Ext.get('funds1_a').set({'value':data.item.funds1__a});
				Ext.get('funds2').set({'value':data.item.funds2});
				Ext.get('funds2_a').set({'value':data.item.funds2__a});
				Ext.get('funds3').set({'value':data.item.funds3});
				Ext.get('funds3_a').set({'value':data.item.funds3__a});
				Ext.get('funds4').set({'value':data.item.funds4});
				Ext.get('funds4_a').set({'value':data.item.funds4__a});
    ...
    function onImportClick(btn){
		action = 'excel.do?action=preview&table=BUDGET_CREDITED';
...
<%=pageList.getPageInfo().getHtml("b_credited.do?action=list&sel_year=" + sel_year + "&sel_name=" + URLEncoder.encode(sel_name, "UTF-8") + "&sel_pjcode=" + URLEncoder.encode(sel_pjcode, "UTF-8") + "&sel_empname=" + URLEncoder.encode(sel_empname, "UTF-8")) %>
  	<br>
    <table width="98%" align="center" vlign="middle" id="the-table">
    	<tr align="center" bgcolor="#E0F1F8"  class="b_tr">
    		...
    		<td rowspan="2">争取</td>
    		<td rowspan="2"><%=sel_year %>年到款</td>
    		<td colspan="8">季度分解</td>
    		<td rowspan="2">说明</td>
    	</tr>
    	<tr align="center" bgcolor="#E0F1F8"  class="b_tr">
    		<td>1季度</td>
...
<%
	for(int i=0;i<listBudgetCredited.size();i++){
		Map mapCredited = (Map)listBudgetCredited.get(i);
%>
		<tr>
			<td><input type="checkbox" name="check" value="<%=mapCredited.get("ID") %>" class="ainput"></td>
			<td><%=mapCredited.get("ORDERCODE")==null?"":mapCredited.get("ORDERCODE") %></td>
			<td><%=mapCredited.get("NAME")==null?"":mapCredited.get("NAME") %></td>
			<td><%=mapCredited.get("PJCODE")==null?"":mapCredited.get("PJCODE") %></td>
			<td><%=mapCredited.get("LEADER_STATION")==null?"":mapCredited.get("LEADER_STATION") %></td>
			<td><%=mapCredited.get("LEADER_TOP")==null?"":mapCredited.get("LEADER_TOP") %></td>
			<td><%=mapCredited.get("LEADER_SECTION")==null?"":mapCredited.get("LEADER_SECTION") %></td>
			<td><%=mapCredited.get("MANAGER")==null?"":mapCredited.get("MANAGER") %></td>
			<td><%=mapCredited.get("CONFIRM")==null?"":mapCredited.get("CONFIRM") %></td>
			<td><%=mapCredited.get("TRY")==null?"":mapCredited.get("TRY") %></td>
			<td><%=mapCredited.get("FUNDS")==null?"":mapCredited.get("FUNDS") %></td>
			<td><%=mapCredited.get("FUNDS1")==null?"":mapCredited.get("FUNDS1") %></td>
			<td><%=mapCredited.get("FUNDS1_A")==null?"":mapCredited.get("FUNDS1_A") %></td>
			<td><%=mapCredited.get("FUNDS2")==null?"":mapCredited.get("FUNDS2") %></td>
			<td><%=mapCredited.get("FUNDS2_A")==null?"":mapCredited.get("FUNDS2_A") %></td>
			<td><%=mapCredited.get("FUNDS3")==null?"":mapCredited.get("FUNDS3") %></td>
			<td><%=mapCredited.get("FUNDS3_A")==null?"":mapCredited.get("FUNDS3_A") %></td>
			<td><%=mapCredited.get("FUNDS4")==null?"":mapCredited.get("FUNDS4") %></td>
			<td><%=mapCredited.get("FUNDS4_A")==null?"":mapCredited.get("FUNDS4_A") %></td>
			<td><%=mapCredited.get("NOTE")==null?"":mapCredited.get("NOTE") %></td>
		</tr>
<%} %>
	</table>
  </form>
...
%>
				  ...
				  <tr>
				    <td>争取</td>
				    <td><input type="text" name="_try" style="width:200"></td>
				  </tr>
				  <tr>
				    <td>年到款</td>
				  ...
				  <tr>
				    <td>1季度已到款</td>
				    <td><input type="text" name="funds1_a" style="width:200"></td>
				  </tr>
				  <tr>
				    <td>2季度</td>
				  ...
				  <tr>
				    <td>2季度已到款</td>
				    <td><input type="text" name="funds2_a" style="width:200"></td>
				  </tr>	
				  <tr>
				    <td>3季度</td>
				  ...
				  <tr>
				    <td>3季度已到款</td>
				    <td><input type="text" name="funds3_a" style="width:200"></td>
				  </tr>	
				  <tr>
				    <td>4季度</td>
				  ...
				  <tr>
				    <td>4季度已到款</td>
				    <td><input type="text" name="funds4_a" style="width:200"></td>
				  </tr>	
				  <tr>
				    <td>说明</td>
