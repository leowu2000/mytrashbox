...
<html>
  <head>
	...
	Ext.onReady(function(){
	    ...
	    document.getElementById('list_manage').src = "/goods.do?action=list_search";
	});
	...
	function commit(){
	  ...
	  document.getElementById('list_manage').src = "/goods.do?action=list_search&sel_depart=" + sel_depart + "&sel_empcode=" + sel_empcode + "&sel_goodsname=" + encodeURI(sel_goodsname) + "&sel_goodscode=" + sel_goodscode;
	}
	</script>
  </head>
