...
<html>
  <head>
	...
	Ext.onReady(function(){
		var comboBoxTree = new Ext.ux.ComboBoxTree({
			...
			listeners:{
	            ...
	            select: function(comboxtree,newNode,oldNode){//选择树结点设值之后的事件   
	                  ...
	                  document.getElementById('list_manage').src = "/em.do?action=list_manage&seldepart=" + newNode.id + "&emname=" + encodeURI(emname) + "&sel_empcode=" + sel_empcode;
	            },   
	    ...
	    document.getElementById('list_manage').src = "/em.do?action=list_manage&seldepart=" + comboBoxTree.getValue() + "&emname=" + encodeURI(emname) + "&sel_empcode=" + sel_empcode + "&h_year=" + h_year + "&h_name=" + encodeURI(h_name);
	});
	...
	function commit(){
	  ...
	  var h_year = document.getElementById('h_year').value;
	  var h_name = document.getElementById('h_name').value;
	  document.getElementById('list_manage').src = "/em.do?action=list_manage&seldepart=" + seldepart + "&emname=" + encodeURI(emname) + "&sel_empcode=" + sel_empcode + "&h_year=" + h_year + "&h_name=" + encodeURI(h_name);
	}
	</script>
  </head>
